# Graph Report - twitch-miner-go  (2026-07-02)

## Corpus Check
- 133 files · ~99,036 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1630 nodes · 2969 edges · 103 communities (79 shown, 24 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7fa8ba02`
...
Cohesion: 0.14
Nodes (18): Attr, Context, Event, Handler, Level, Mutex, colorHandler, Config (+10 more)
...
Cohesion: 0.13
Nodes (17): API, Bool, CategoryWatcher, Dispatcher, AccountConfig, EventPrediction, Logger, Miner (+9 more)
...
Cohesion: 0.18
Nodes (15): Handler, Logger, RWMutex, Server, AnalyticsServer, Streamer, checkCredentials(), NewAnalyticsServer() (+7 more)
...
Cohesion: 0.32
Nodes (16): NewServer(), HandlerFunc, Context, T, checkWithURL(), DownloadAsset(), TestCheckForUpdate_DevVersion(), TestCheckForUpdate_NewerAvailable() (+8 more)

### Community 34 - "Community 34"
Cohesion: 0.21
Nodes (14): applyDefaults(), applyEnvOverrides(), getEnv(), isOwnerAccount(), LoadAccountConfig(), LoadAllAccountConfigs(), parseProxyURL(), TestApplyDefaultsSetsMaxWatchStreams() (+6 more)
...
Cohesion: 0.29
Nodes (9): ghAsset, ghAsset, ghRelease, UpdateInfo, CheckForUpdate(), findAssetURL(), FormatNotification(), isGitRepo() (+1 more)
...
Cohesion: 0.16
Nodes (21): AnalyticsServer, AccountConfig, Context, Level, Logger, Twitch, Logger, ParseLevel() (+13 more)
...
## Knowledge Gaps
- **428 isolated node(s):** `_edit-config.sh script`, `DEFAULT_SERVICE_NAME`, `DEFAULT_INSTALL_DIR`, `DEFAULT_CONFIG_DIR`, `DEFAULT_DATA_DIR` (+423 more)
...
- **Why does `Parse()` connect `Community 35` to `Community 33`, `Community 34`, `Community 46`, `Community 17`, `Community 19`, `Community 24`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `Miner` connect `Community 28` to `Community 50`, `Community 101`, `Community 38`?**
