...
func TestBuildBodyBetResultNamesChannel(t *testing.T) {
	...
	want := strings.Join([]string{
		"🏆 Wette gewonnen",
		"Kanal: psychohypnotic (phasmophobia)",
		"Frage: Will it be Obambo, Thaye or Il Mimo?",
		"Getippt: Yes (BLUE) · 881 Punkte",
		"Ergebnis: WIN, Gained: +1762",
	}, "\n")
...
func TestMatrixHTMLEscapesAndEmphasises(t *testing.T) {
	got := matrixHTML("3jakec | 📺 psychohypnotic", "🏆 Wette gewonnen\nKanal: psychohypnotic (phasmophobia)")

	want := "<b>3jakec | 📺 psychohypnotic</b>" +
		"<br/><b>🏆 Wette gewonnen</b>" +
		"<br/><b>Kanal:</b> psychohypnotic (phasmophobia)"
...
func TestMatrixHTMLEscapesHostileTitles(t *testing.T) {
	...
	got := matrixHTML("", "🎰 Wette\nFrage: <img src=x onerror=alert(1)>")
